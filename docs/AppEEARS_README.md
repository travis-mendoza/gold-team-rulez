...
## 1. Request Parameters  
    ...
    Name: California_Field  

    Date Completed: 2024-10-05T23:52:19.163415  

    ID: 00962665-8b82-419c-9069-b18dcc95187e  
...
- California-Field-L09-002-metadata.xml
- California-Field-granule-list.txt
- California-Field-request.json
- L09-002-SR-QA-AEROSOL-CU-lookup.csv
- L09-002-QA-PIXEL-CU-lookup.csv
- L09-002-QA-RADSAT-CU-lookup.csv
- L09-002-QA-LINEAGE-CU-lookup.csv
- L09-002-SR-QA-AEROSOL-CU-Statistics-QA.csv
- L09-002-QA-PIXEL-CU-Statistics-QA.csv
- L09-002-QA-RADSAT-CU-Statistics-QA.csv
- L09-002-QA-LINEAGE-CU-Statistics-QA.csv
- L09-002-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 32  
Total Size of Extracted Data Files: 0.09 MB  
